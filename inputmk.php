...
<div class="container mt-3">
  <h2 title="vivintamara">ENTRI MATA KULIAH</h2>
  <form action="fc.php" method="POST">
    ...
    <button type="submit" name="vivin" class="btn btn-primary" title="vivintamara">Simpan record</button> <a href="dft.php" class="btn btn-dark" title="vivintamara"> Daftar mata kuliah</a>
  </form>
</div>
</body>
</html>
